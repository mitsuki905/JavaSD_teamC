...
<%-- base1.jsp でBootstrapを読み込んでいない場合は、以下の行を追加してください --%>
...
<c:import url="/base1.jsp">
    <c:param name="body">
        ...
        <%-- Bootstrapのカードコンポーネントを使ってフォーム全体を囲みます --%>
        <!--  <div class="card mx-auto" style="max-width: 700px; margin-top: 2rem;">-->
            ...
            <div class="card-body">
                <form action="【フォームの送信先URL】" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="studentId" name="studentId" placeholder="学生番号を入力してください">
                    </div>

                    <%-- 氏名 --%>
                    <div class="mb-3">
                        <label for="student_name" class="form-label">氏名</label>
                        <input type="text" class="form-control" id="student_name" name="class_num" placeholder="氏名を入力してください">
                    </div>
                    ...
                    <!-- <select class="form-select" id="class_num" name="class_num">
                            <c:forEach var="classItem" items="${classList}">
                                <option value="${classItem.classNum}" <c:if test="${classItem.classNum == classNum}">selected</c:if>>
                                    ${classItem.classNum}
                                </option>
                            </c:forEach>
                        </select> -->
